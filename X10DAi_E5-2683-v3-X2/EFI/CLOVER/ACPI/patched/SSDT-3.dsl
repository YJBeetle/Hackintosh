...
DefinitionBlock ("ssdt.aml", "SSDT", 1, "APPLE ", "CpuPm", 0x00018900)
{
    ...
    Scope (\_SB_.SCK1.CP00)
    {
        ...
        Method (ACST, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP00.ACST Called", Debug)
            Store ("CP00 C-States    : 13", Debug)
    ...
    Scope (\_SB_.SCK1.CP01)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP01.APSS Called", Debug)

            Return (\_SB_.SCK1.CP00.APSS)
        }

        Method (ACST, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP01.ACST Called", Debug)
            Store ("CP01 C-States    : 13", Debug)
    ...
    Scope (\_SB_.SCK1.CP02)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP02.APSS Called", Debug)

            Return (\_SB_.SCK1.CP00.APSS)
        }

        Method (ACST, 0, NotSerialized) { Return (\_SB_.SCK1.CP01.ACST ()) }
    }

    Scope (\_SB_.SCK1.CP03)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP03.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP04)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP04.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP05)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP05.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP06)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP06.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP07)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP07.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP08)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP08.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP09)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP09.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP0A)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP0A.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP0B)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP0B.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP0C)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP0C.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP0D)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP0D.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP0E)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP0E.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP0F)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP0F.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP10)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP10.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP11)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP11.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP12)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP12.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP13)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP13.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP14)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP14.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP15)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP15.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP16)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP16.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP17)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP17.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP18)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP18.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP19)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP19.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP1A)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP1A.APSS Called", Debug)
    ...
    Scope (\_SB_.SCK1.CP1B)
    {
        Method (APSS, 0, NotSerialized)
        {
            Store ("Method _SB_.SCK1.CP1B.APSS Called", Debug)
